	...
	<div class="col-xs-12">
        <div class="box box-danger">
			<div class="box-header" style="margin-top:-20px">
				<h3>Mobil Transmisi Automatic </h3>				
			</div>									
		</div>
	</div>	
    <?php foreach ($data_at as $v) : ?>
        <div class="col-xs-3">
            <div class="box box-danger">
                <div class="box-body table-responsive text-center">
...
<div class="row">	
	<div class="col-xs-12">
        <div class="box box-warning">
			<div class="box-header" style="margin-top:-20px">
				<h3>Mobil Transmisi Manual </h3>				
			</div>									
		</div>
	</div>	
    <?php foreach ($data_manual as $v) : ?>
        <div class="col-xs-3">
            <div class="box box-warning">
                <div class="box-body table-responsive text-center">
                    <a href="?c=home&m=viewkatalog&id=<?= $v->id ?>" style="color:black">
                    ...
                    <a href="?c=home&m=viewkatalog&id=<?= $v->id ?>" class="btn btn-sm btn-warning form-control">
                        <span>
                            Lihat Detail
                        </span>
                        <i class="fa fa-arrow-right"></i>
